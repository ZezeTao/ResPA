...
parser.add_argument("--batch_size", type=int, default=32, help="How many images process at one time.")
parser.add_argument("--momentum", type=float, default=1.0, help="Momentum")
parser.add_argument("--N", type=int, default=5, help="The number of sampled examples")
parser.add_argument("--delta", type=float, default=0.4, help="The balanced coefficient")
parser.add_argument("--beta1", type=float, default=0.4, help="The balanced coefficient")
parser.add_argument("--zeta", type=float, default=1.5, help="The upper bound of neighborhood")
...
def ResPA(images, gt, model, min, max):
    """
...
def main():
    ...
    for images, images_ID,  gt_cpu in tqdm(data_loader):
        ...
        adv_img = ResPA(images, gt, model, images_min, images_max)
        adv_img_np = adv_img.cpu().numpy()
        adv_img_np = np.transpose(adv_img_np, (0, 2, 3, 1)) * 255
        save_image(adv_img_np, images_ID, './incv3_ResPA_outputs/')
